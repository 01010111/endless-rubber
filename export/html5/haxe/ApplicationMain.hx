...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("EndlessRubber", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("EndlessRubber", null, 640, 480);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "EndlessRubber";
		app.meta["name"] = "EndlessRubber";
